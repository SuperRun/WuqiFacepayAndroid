...
//                Color.parseColor("#3cf16d7a"));
    ...
    private static class InnerHandler extends Handler {
        private WeakReference<FaceRegisterActivity> mWeakReference;

        public InnerHandler(FaceRegisterActivity activity) {
            super();
            this.mWeakReference = new WeakReference<FaceRegisterActivity>(activity);
        }
        ...
        public void handleMessage(Message msg) {
            ...
            FaceRegisterActivity activity = mWeakReference.get();
            if (activity == null) {
                return;
            }
            if (msg == null) {
